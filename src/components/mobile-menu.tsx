 ...
 * ScrambleFx mutates text nodes it discovers once on mount.
 */
            ...
            {items.map((item, i) => (
              <li key={item.href}>
                <a
                  ...
                  className="flex items-baseline gap-3 py-3 font-mono text-sm uppercase tracking-widest text-muted transition-colors hover:text-accent"
                >
